...
#######################################################################
#  slasvbatchrnwlltr1.sh           
#      This script is used to invoke Batch Renewal Letter 1
#      
...
export PROCESSID=RNWLLTR1
export OUTFILE=slasvbatchrnwlltr1.out
export ERRFILE=slasvbatchrnwlltr1.err 
export LOGFILE=slasvbatchrnwlltr1.log
...
# PACE pager stuff
########################################################################
export TMPFILE=slasvbatchrnwlltr1tmp.log
export PACE=telalert@mom.assurant-inc.com
export PRIMARY="SolarFTPagerPri"
echo "Check slasvbatchrnwlltr1.log--" $ENVIRON > $FILEPATH$TMPFILE
...
JOBSTRING="Batch Renewal Letter 1"
if [ $Ret -eq 0 ] 
then
