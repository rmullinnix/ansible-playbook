...
#######################################################################
#  slasvbatchratecomparesc.sh           
#      This script is used to invoke the Batch Rate Compare for COMPASS
#      
#      Runs monthly. Autosys job name P3SLMRCC 
#  
#   Revision History:
#   04/11/2014 L. Harnack         Initial Development
########################################################################
...
export PROCESSID=RATECOMPSC
export OUTFILE=slasvbatchratecomparesc.out
export ERRFILE=slasvbatchratecomparesc.err 
export LOGFILE=slasvbatchratecomparesc.log
...
# PACE pager stuff
########################################################################
export TMPFILE=slasvbatchratecomparesctmp.log
export PACE=telalert@mom.assurant-inc.com
export PRIMARY="SolarFTPagerPri"
echo "Check slasvbatchratecomparesc.log--" $ENVIRON > $FILEPATH$TMPFILE
...
JOBSTRING="Batch COMPASS Rate Compare"
if [ $Ret -eq 0 ] 
then
