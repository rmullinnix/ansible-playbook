...
#      This script is used to invoke Cross Sell Load on linux
#      
#   Revision History:
#   06/10/2014 T. Meek      Initial Development
########################################################################
...
export FILEPATH={{ solar_app_path }}/log/slasvbatchcrosssellload/
export PROCESSID=CROSSSELLLOAD
export OUTFILE=batchcrosssellload.out
export ERRFILE=batchcrosssellload.err 
export LOGFILE=batchcrosssellload.log
...
# PACE pager stuff
########################################################################
export TMPFILE=slasvbatchcrosssellloadtmp.log
export PACE=telalert@mom.assurant-inc.com
export PRIMARY="SolarFTPagerPri"
echo "Check slasvbatchcrosssellload.log--" $ENVIRON > $FILEPATH$TMPFILE
