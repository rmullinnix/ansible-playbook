...
#######################################################################
#  slasvbatchrnwlltr2.sh           
#      This script is used to invoke Batch Renewal Letter 2
#      
...
export PROCESSID=RNWLLTR2
export OUTFILE=slasvbatchrnwlltr2.out
export ERRFILE=slasvbatchrnwlltr2.err 
export LOGFILE=slasvbatchrnwlltr2.log
...
# PACE pager stuff
########################################################################
export TMPFILE=slasvbatchrnwlltr2tmp.log
export PACE=telalert@mom.assurant-inc.com
export PRIMARY="SolarFTPagerPri"
echo "Check slasvbatchrnwlltr2.log--" $ENVIRON > $FILEPATH$TMPFILE
...
JOBSTRING="Batch Renewal Letter 2"
if [ $Ret -eq 0 ] 
then
