...
#######################################################################
#  slasvbatchrnwlltr3.sh           
#      This script is used to invoke Batch Renewal Letter 3
#      
...
export PROCESSID=RNWLLTR3
export OUTFILE=slasvbatchrnwlltr3.out
export ERRFILE=slasvbatchrnwlltr3.err 
export LOGFILE=slasvbatchrnwlltr3.log
...
# PACE pager stuff
########################################################################
export TMPFILE=slasvbatchrnwlltr3tmp.log
export PACE=telalert@mom.assurant-inc.com
export PRIMARY="SolarFTPagerPri"
echo "Check slasvbatchrnwlltr3.log--" $ENVIRON > $FILEPATH$TMPFILE
...
JOBSTRING="Batch Renewal Letter 3"
if [ $Ret -eq 0 ] 
then
